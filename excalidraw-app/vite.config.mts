  ...
  return {
    ...
    plugins: [
      ...
      VitePWA({
        ...
        manifest: {
          short_name: "NovaBoard",
          name: "NovaBoard",
          description:
            "NovaBoard is a whiteboard tool that lets you easily sketch diagrams that have a hand-drawn feel to them.",
          icons: [
            {
